...
<body class="min-h-screen w-screen bg-background text-foreground overflow-x-hidden">
  ...
  <nav class="container mx-auto bg-sidebar text-sidebar-foreground py-4 px-6 rounded-b-[--radius] shadow-md">
    <div class="flex items-center justify-end gap-6">
      <a href="/" class="px-3 py-1 rounded-md text-sidebar-accent-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground transition-colors">Movies</a>
      <a href="/shows" class="px-3 py-1 rounded-md text-sidebar-accent-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground transition-colors">Shows</a>
    </div>
  </nav>
